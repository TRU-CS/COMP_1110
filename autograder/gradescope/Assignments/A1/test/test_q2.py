    ...
    def test_three_digit_number(self):
        ...
        with patch('builtins.input', side_effect=['123']):
            with patch('builtins.print') as mocked_print:
                ...
                output = [call.args for call in mocked_print.call_args_list]
                self.assertTrue(any("is a" in str(line) for line in output))
    ...
    def test_not_three_digit_number(self):
        ...
        with patch('builtins.input', side_effect=['45']):
            with patch('builtins.print') as mocked_print:
                ...
                output = [call.args for call in mocked_print.call_args_list]
                self.assertTrue(any("not " in str(line) for line in output))
    ...
    def test_invalid_input(self):
        ...
        with patch('builtins.input', side_effect=['abc']):
            with patch('builtins.print') as mocked_print:
                ...
                output = [call.args for call in mocked_print.call_args_list]
                self.assertTrue(any("Invalid input" in str(line) for line in output))
